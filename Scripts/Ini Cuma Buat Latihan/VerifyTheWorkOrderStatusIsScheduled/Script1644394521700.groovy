...
String value = WebUI.getText(findTestObject('Page_SKT ERP  ERP/ValueOfWorkOrderWithSpecificData'))

WebUI.comment(value)

WebUI.verifyMatch(value, 'scheduled', true)

/*ini nge verify kalo udah scheduled (dgn specific data(pake no.spk)) tapi belum yang nge approve, bisa nge approve tapi 
 * dengan baris tertentu di table, cuma kalo dengan specific data (pake no.spk) blm bisa soalnya tombol approve nya diluar circle no spk*/
